...
const links = [
  { href: "https://github.com/siddharthsreenivas", icon: <FaDiscord /> },
  { href: "https://github.com/siddharthsreenivas", icon: <FaTwitter /> },
  { href: "https://github.com/siddharthsreenivas", icon: <FaGithub /> },
  { href: "https://github.com/siddharthsreenivas", icon: <FaTwitch /> },
];
